...
using JsonSocialNetwork.API.Controllers.Hubs;
...
namespace JsonSocialNetwork.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddCors(
                options =>
                {
                    ...
                    options.AddPolicy("Specific",
                        builder =>
                        builder.WithOrigins("http://localhost:5002","http://192.168.0.192:5002")
                            .AllowAnyHeader()
                            .AllowAnyMethod()
                            .AllowCredentials());
                });
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "JsonSocialNetwork.API", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "JsonSocialNetwork.API v1"));
            }
